 ...
 *
 * - generateProductDescription - A function that generates a product description based on keywords.
...
const prompt = ai.definePrompt({
  ...
  Generate a compelling and engaging product description using the following keywords:
  {{keywords}}
